...
PROTOBUF_CONSTEXPR WorkerConfig::WorkerConfig(
  ...
  , /*decltype(_impl_.data_transfer_port_)*/int64_t{0}
  , /*decltype(_impl_._cached_size_)*/{}} {}
...
const ::_pbi::DescriptorTable descriptor_table_tensorflow_2fcore_2fprotobuf_2fservice_5fconfig_2eproto = {
    false, false, 981, descriptor_table_protodef_tensorflow_2fcore_2fprotobuf_2fservice_5fconfig_2eproto,
...
WorkerConfig::WorkerConfig(const WorkerConfig& from)
  ...
  new (&_impl_) Impl_{
    ...
    , decltype(_impl_.data_transfer_port_){}
    , /*decltype(_impl_._cached_size_)*/{}};
  ...
  ::memcpy(&_impl_.port_, &from._impl_.port_,
    static_cast<size_t>(reinterpret_cast<char*>(&_impl_.data_transfer_port_) -
    ...
    switch (tag >> 3) {
      ...
      case 13:
        if (PROTOBUF_PREDICT_TRUE(static_cast<uint8_t>(tag) == 104)) {
          _impl_.data_transfer_port_ = ::PROTOBUF_NAMESPACE_ID::internal::ReadVarint64(&ptr);
          CHK_(ptr);
        } else
          goto handle_unusual;
        continue;
...
uint8_t* WorkerConfig::_InternalSerialize(
  ...
  // int64 data_transfer_port = 13;
  if (this->_internal_data_transfer_port() != 0) {
    target = stream->EnsureSpace(target);
    target = ::_pbi::WireFormatLite::WriteInt64ToArray(13, this->_internal_data_transfer_port(), target);
  }
...
// @@protoc_insertion_point(message_byte_size_start:tensorflow.data.experimental.WorkerConfig)
  ...
  // int64 data_transfer_port = 13;
  if (this->_internal_data_transfer_port() != 0) {
    total_size += ::_pbi::WireFormatLite::Int64SizePlusOne(this->_internal_data_transfer_port());
  }
...
void WorkerConfig::MergeImpl(::PROTOBUF_NAMESPACE_ID::Message& to_msg, const ::PROTOBUF_NAMESPACE_ID::Message& from_msg) {
  ...
  if (from._internal_data_transfer_port() != 0) {
    _this->_internal_set_data_transfer_port(from._internal_data_transfer_port());
  }
  _this->_internal_metadata_.MergeFrom<::PROTOBUF_NAMESPACE_ID::UnknownFieldSet>(from._internal_metadata_);
}
