...
PROTOBUF_CONSTEXPR ServiceOptions::ServiceOptions(
    ::_pbi::ConstantInitialized): _impl_{
    /*decltype(_impl_.optional_pinned_)*/{}
  , /*decltype(_impl_._cached_size_)*/{}
  , /*decltype(_impl_._oneof_case_)*/{}} {}
...
PROTOBUF_CONSTEXPR Options::Options(
  ...
  , /*decltype(_impl_.service_options_)*/nullptr
...
static ::_pb::Metadata file_level_metadata_tensorflow_2fcore_2fframework_2fdataset_5foptions_2eproto[7];
...
static const ::_pbi::MigrationSchema schemas[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
  ...
  { 62, -1, -1, sizeof(::tensorflow::data::ServiceOptions)},
  { 70, -1, -1, sizeof(::tensorflow::data::ThreadingOptions)},
  { 80, -1, -1, sizeof(::tensorflow::data::Options)},
};
...
const ::_pbi::DescriptorTable descriptor_table_tensorflow_2fcore_2fframework_2fdataset_5foptions_2eproto = {
    false, false, 2756, descriptor_table_protodef_tensorflow_2fcore_2fframework_2fdataset_5foptions_2eproto,
    "tensorflow/core/framework/dataset_options.proto",
    &descriptor_table_tensorflow_2fcore_2fframework_2fdataset_5foptions_2eproto_once, descriptor_table_tensorflow_2fcore_2fframework_2fdataset_5foptions_2eproto_deps, 1, 7,
...
ServiceOptions::ServiceOptions(const ServiceOptions& from)
  ...
  switch (from.optional_pinned_case()) {
    case kPinned: {
...
#define CHK_(x) if (PROTOBUF_PREDICT_FALSE(!(x))) goto failure
  while (!ctx->Done(&ptr)) {
    ...
    switch (tag >> 3) {
      ...
      case 1:
        if (PROTOBUF_PREDICT_TRUE(static_cast<uint8_t>(tag) == 8)) {
          _internal_set_pinned(::PROTOBUF_NAMESPACE_ID::internal::ReadVarint64(&ptr));
          CHK_(ptr);
        } else
          goto handle_unusual;
        continue;
...
class Options::_Internal {
 public:
  ...
  static const ::tensorflow::data::ServiceOptions& service_options(const Options* msg);
...
const ::tensorflow::data::ServiceOptions&
Options::_Internal::service_options(const Options* msg) {
  return *msg->_impl_.service_options_;
}
...
Options::Options(const Options& from)
  ...
  if (from._internal_has_service_options()) {
    _this->_impl_.service_options_ = new ::tensorflow::data::ServiceOptions(*from._impl_.service_options_);
  }
...
inline void Options::SharedDtor() {
  ...
  if (this != internal_default_instance()) delete _impl_.service_options_;
...
uint8_t* Options::_InternalSerialize(
  ...
  if (this->_internal_has_service_options()) {
    target = ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::
      InternalWriteMessage(12, _Internal::service_options(this),
        _Internal::service_options(this).GetCachedSize(), target, stream);
  }
...
void Options::MergeImpl(::PROTOBUF_NAMESPACE_ID::Message& to_msg, const ::PROTOBUF_NAMESPACE_ID::Message& from_msg) {
  ...
  if (from._internal_has_service_options()) {
    _this->_internal_mutable_service_options()->::tensorflow::data::ServiceOptions::MergeFrom(
        from._internal_service_options());
  }
  switch (from.optional_dataset_name_case()) {
    case kDatasetName: {
      _this->_internal_set_dataset_name(from._internal_dataset_name());
...
::PROTOBUF_NAMESPACE_ID::Metadata Options::GetMetadata() const {
  return ::_pbi::AssignDescriptors(
      &descriptor_table_tensorflow_2fcore_2fframework_2fdataset_5foptions_2eproto_getter, &descriptor_table_tensorflow_2fcore_2fframework_2fdataset_5foptions_2eproto_once,
      file_level_metadata_tensorflow_2fcore_2fframework_2fdataset_5foptions_2eproto[6]);
}
...
template<> PROTOBUF_NOINLINE ::tensorflow::data::ServiceOptions*
Arena::CreateMaybeMessage< ::tensorflow::data::ServiceOptions >(Arena* arena) {
  return Arena::CreateMessageInternal< ::tensorflow::data::ServiceOptions >(arena);
}
