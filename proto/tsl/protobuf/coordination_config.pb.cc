...
PROTOBUF_CONSTEXPR CoordinationServiceConfig::CoordinationServiceConfig(
  ...
  , /*decltype(_impl_.poll_for_error_from_service_at_startup_)*/false
  , /*decltype(_impl_._cached_size_)*/{}} {}
...
const ::_pbi::DescriptorTable descriptor_table_tsl_2fprotobuf_2fcoordination_5fconfig_2eproto = {
    false, false, 667, descriptor_table_protodef_tsl_2fprotobuf_2fcoordination_5fconfig_2eproto,
    "tsl/protobuf/coordination_config.proto",
...
CoordinationServiceConfig::CoordinationServiceConfig(const CoordinationServiceConfig& from)
  ...
  new (&_impl_) Impl_{
    ...
    , decltype(_impl_.poll_for_error_from_service_at_startup_){}
    , /*decltype(_impl_._cached_size_)*/{}};
  ...
  ::memcpy(&_impl_.cluster_register_timeout_in_ms_, &from._impl_.cluster_register_timeout_in_ms_,
    static_cast<size_t>(reinterpret_cast<char*>(&_impl_.poll_for_error_from_service_at_startup_) -
    ...
    switch (tag >> 3) {
      ...
      case 13:
        if (PROTOBUF_PREDICT_TRUE(static_cast<uint8_t>(tag) == 104)) {
          _impl_.poll_for_error_from_service_at_startup_ = ::PROTOBUF_NAMESPACE_ID::internal::ReadVarint64(&ptr);
          CHK_(ptr);
        } else
          goto handle_unusual;
        continue;
...
uint8_t* CoordinationServiceConfig::_InternalSerialize(
  ...
  // bool poll_for_error_from_service_at_startup = 13;
  if (this->_internal_poll_for_error_from_service_at_startup() != 0) {
    target = stream->EnsureSpace(target);
    target = ::_pbi::WireFormatLite::WriteBoolToArray(13, this->_internal_poll_for_error_from_service_at_startup(), target);
  }
...
void CoordinationServiceConfig::MergeImpl(::PROTOBUF_NAMESPACE_ID::Message& to_msg, const ::PROTOBUF_NAMESPACE_ID::Message& from_msg) {
  ...
  if (from._internal_poll_for_error_from_service_at_startup() != 0) {
    _this->_internal_set_poll_for_error_from_service_at_startup(from._internal_poll_for_error_from_service_at_startup());
  }
  _this->_internal_metadata_.MergeFrom<::PROTOBUF_NAMESPACE_ID::UnknownFieldSet>(from._internal_metadata_);
}
