...
static ::_pb::Metadata file_level_metadata_tensorflow_5fserving_2fapis_2fstatus_2eproto[1];
static constexpr ::_pb::EnumDescriptor const** file_level_enum_descriptors_tensorflow_5fserving_2fapis_2fstatus_2eproto = nullptr;
static constexpr ::_pb::ServiceDescriptor const** file_level_service_descriptors_tensorflow_5fserving_2fapis_2fstatus_2eproto = nullptr;

const uint32_t TableStruct_tensorflow_5fserving_2fapis_2fstatus_2eproto::offsets[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
  ~0u,  // no _has_bits_
...
const char descriptor_table_protodef_tensorflow_5fserving_2fapis_2fstatus_2eproto[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) =
...
static ::_pbi::once_flag descriptor_table_tensorflow_5fserving_2fapis_2fstatus_2eproto_once;
const ::_pbi::DescriptorTable descriptor_table_tensorflow_5fserving_2fapis_2fstatus_2eproto = {
    false, false, 224, descriptor_table_protodef_tensorflow_5fserving_2fapis_2fstatus_2eproto,
    "tensorflow_serving/apis/status.proto",
    &descriptor_table_tensorflow_5fserving_2fapis_2fstatus_2eproto_once, descriptor_table_tensorflow_5fserving_2fapis_2fstatus_2eproto_deps, 1, 1,
    schemas, file_default_instances, TableStruct_tensorflow_5fserving_2fapis_2fstatus_2eproto::offsets,
    file_level_metadata_tensorflow_5fserving_2fapis_2fstatus_2eproto, file_level_enum_descriptors_tensorflow_5fserving_2fapis_2fstatus_2eproto,
    file_level_service_descriptors_tensorflow_5fserving_2fapis_2fstatus_2eproto,
};
PROTOBUF_ATTRIBUTE_WEAK const ::_pbi::DescriptorTable* descriptor_table_tensorflow_5fserving_2fapis_2fstatus_2eproto_getter() {
  return &descriptor_table_tensorflow_5fserving_2fapis_2fstatus_2eproto;
}

// Force running AddDescriptors() at dynamic initialization time.
PROTOBUF_ATTRIBUTE_INIT_PRIORITY2 static ::_pbi::AddDescriptorsRunner dynamic_init_dummy_tensorflow_5fserving_2fapis_2fstatus_2eproto(&descriptor_table_tensorflow_5fserving_2fapis_2fstatus_2eproto);
namespace tensorflow {
namespace serving {
    ...
    switch (tag >> 3) {
      ...
      case 2:
        if (PROTOBUF_PREDICT_TRUE(static_cast<uint8_t>(tag) == 18)) {
          ...
          CHK_(ptr);
          CHK_(::_pbi::VerifyUTF8(str, "tensorflow.serving.StatusProto.error_message"));
        } else
          goto handle_unusual;
        continue;
      default:
...
::PROTOBUF_NAMESPACE_ID::Metadata StatusProto::GetMetadata() const {
  return ::_pbi::AssignDescriptors(
      &descriptor_table_tensorflow_5fserving_2fapis_2fstatus_2eproto_getter, &descriptor_table_tensorflow_5fserving_2fapis_2fstatus_2eproto_once,
      file_level_metadata_tensorflow_5fserving_2fapis_2fstatus_2eproto[0]);
}
...
template<> PROTOBUF_NOINLINE ::tensorflow::serving::StatusProto*
