...
class SessionService final {
 public:
  ...
  template <class BaseClass>
  class WithCallbackMethod_SessionRun : public BaseClass {
   private:
    void BaseClassMustBeDerivedFromService(const Service* /*service*/) {}
   public:
    WithCallbackMethod_SessionRun() {
      ::grpc::Service::MarkMethodCallback(0,
          new ::grpc::internal::CallbackUnaryHandler< ::tensorflow::serving::SessionRunRequest, ::tensorflow::serving::SessionRunResponse>(
            [this](
                   ::grpc::CallbackServerContext* context, const ::tensorflow::serving::SessionRunRequest* request, ::tensorflow::serving::SessionRunResponse* response) { return this->SessionRun(context, request, response); }));}
    void SetMessageAllocatorFor_SessionRun(
        ::grpc::MessageAllocator< ::tensorflow::serving::SessionRunRequest, ::tensorflow::serving::SessionRunResponse>* allocator) {
    ...
    ~WithCallbackMethod_SessionRun() override {
      BaseClassMustBeDerivedFromService(this);
    }
    // disable synchronous version of this method
    ::grpc::Status SessionRun(::grpc::ServerContext* /*context*/, const ::tensorflow::serving::SessionRunRequest* /*request*/, ::tensorflow::serving::SessionRunResponse* /*response*/) override {
    ...
    virtual ::grpc::ServerUnaryReactor* SessionRun(
      ::grpc::CallbackServerContext* /*context*/, const ::tensorflow::serving::SessionRunRequest* /*request*/, ::tensorflow::serving::SessionRunResponse* /*response*/)  { return nullptr; }
  };
  typedef WithCallbackMethod_SessionRun<Service > CallbackService;
  ...
  template <class BaseClass>
  class WithRawCallbackMethod_SessionRun : public BaseClass {
   private:
    void BaseClassMustBeDerivedFromService(const Service* /*service*/) {}
   public:
    WithRawCallbackMethod_SessionRun() {
      ::grpc::Service::MarkMethodRawCallback(0,
          new ::grpc::internal::CallbackUnaryHandler< ::grpc::ByteBuffer, ::grpc::ByteBuffer>(
            [this](
                   ::grpc::CallbackServerContext* context, const ::grpc::ByteBuffer* request, ::grpc::ByteBuffer* response) { return this->SessionRun(context, request, response); }));
    }
    ~WithRawCallbackMethod_SessionRun() override {
      BaseClassMustBeDerivedFromService(this);
    }
    // disable synchronous version of this method
    ::grpc::Status SessionRun(::grpc::ServerContext* /*context*/, const ::tensorflow::serving::SessionRunRequest* /*request*/, ::tensorflow::serving::SessionRunResponse* /*response*/) override {
