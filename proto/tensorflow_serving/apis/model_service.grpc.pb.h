...
class ModelService final {
 public:
  ...
  class WithCallbackMethod_GetModelStatus : public BaseClass {
   ...
   public:
    WithCallbackMethod_GetModelStatus() {
      ::grpc::Service::MarkMethodCallback(0,
          new ::grpc::internal::CallbackUnaryHandler< ::tensorflow::serving::GetModelStatusRequest, ::tensorflow::serving::GetModelStatusResponse>(
            [this](
                   ::grpc::CallbackServerContext* context, const ::tensorflow::serving::GetModelStatusRequest* request, ::tensorflow::serving::GetModelStatusResponse* response) { return this->GetModelStatus(context, request, response); }));}
    void SetMessageAllocatorFor_GetModelStatus(
        ::grpc::MessageAllocator< ::tensorflow::serving::GetModelStatusRequest, ::tensorflow::serving::GetModelStatusResponse>* allocator) {
    ...
    virtual ::grpc::ServerUnaryReactor* GetModelStatus(
      ::grpc::CallbackServerContext* /*context*/, const ::tensorflow::serving::GetModelStatusRequest* /*request*/, ::tensorflow::serving::GetModelStatusResponse* /*response*/)  { return nullptr; }
  };
  template <class BaseClass>
  class WithCallbackMethod_HandleReloadConfigRequest : public BaseClass {
   private:
    void BaseClassMustBeDerivedFromService(const Service* /*service*/) {}
   public:
    WithCallbackMethod_HandleReloadConfigRequest() {
      ::grpc::Service::MarkMethodCallback(1,
          new ::grpc::internal::CallbackUnaryHandler< ::tensorflow::serving::ReloadConfigRequest, ::tensorflow::serving::ReloadConfigResponse>(
            [this](
                   ::grpc::CallbackServerContext* context, const ::tensorflow::serving::ReloadConfigRequest* request, ::tensorflow::serving::ReloadConfigResponse* response) { return this->HandleReloadConfigRequest(context, request, response); }));}
    void SetMessageAllocatorFor_HandleReloadConfigRequest(
        ::grpc::MessageAllocator< ::tensorflow::serving::ReloadConfigRequest, ::tensorflow::serving::ReloadConfigResponse>* allocator) {
    ...
    ~WithCallbackMethod_HandleReloadConfigRequest() override {
      BaseClassMustBeDerivedFromService(this);
    }
    // disable synchronous version of this method
    ::grpc::Status HandleReloadConfigRequest(::grpc::ServerContext* /*context*/, const ::tensorflow::serving::ReloadConfigRequest* /*request*/, ::tensorflow::serving::ReloadConfigResponse* /*response*/) override {
    ...
    virtual ::grpc::ServerUnaryReactor* HandleReloadConfigRequest(
      ::grpc::CallbackServerContext* /*context*/, const ::tensorflow::serving::ReloadConfigRequest* /*request*/, ::tensorflow::serving::ReloadConfigResponse* /*response*/)  { return nullptr; }
  };
  typedef WithCallbackMethod_GetModelStatus<WithCallbackMethod_HandleReloadConfigRequest<Service > > CallbackService;
  ...
  template <class BaseClass>
  class WithRawCallbackMethod_HandleReloadConfigRequest : public BaseClass {
   private:
    void BaseClassMustBeDerivedFromService(const Service* /*service*/) {}
   public:
    WithRawCallbackMethod_HandleReloadConfigRequest() {
      ::grpc::Service::MarkMethodRawCallback(1,
          new ::grpc::internal::CallbackUnaryHandler< ::grpc::ByteBuffer, ::grpc::ByteBuffer>(
            [this](
                   ::grpc::CallbackServerContext* context, const ::grpc::ByteBuffer* request, ::grpc::ByteBuffer* response) { return this->HandleReloadConfigRequest(context, request, response); }));
    }
    ~WithRawCallbackMethod_HandleReloadConfigRequest() override {
      BaseClassMustBeDerivedFromService(this);
    }
    // disable synchronous version of this method
    ::grpc::Status HandleReloadConfigRequest(::grpc::ServerContext* /*context*/, const ::tensorflow::serving::ReloadConfigRequest* /*request*/, ::tensorflow::serving::ReloadConfigResponse* /*response*/) override {
